...
const I18N = {
  ka:{ company_name: "ლოკიტო", nav_catalog:"კატალოგი", nav_unlock:"გაღების მეთოდები",
       ...
       p_rfid_name:"RFID ბარათი", p_rfid_desc:"უკონტაქტო ბარათი/ბრელოკი ჭკვიანი საკეტის გასაღებად. დამატებითი ბარათები ოჯახის წევრებისა და თანამშრომლებისთვის.",
  ...
  ru:{ company_name: "локито", nav_catalog:"Каталог", nav_unlock:"Способы открытия",
       ...
       p_rfid_name:"RFID-карта", p_rfid_desc:"Бесконтактная карта/брелок для открытия умного замка. Дополнительные карты для членов семьи и сотрудников.",
  ...
  en:{ company_name: "lockito", nav_catalog:"Catalog", nav_unlock:"Unlock methods",
       ...
       p_rfid_name:"RFID card", p_rfid_desc:"Contactless card/fob to unlock your smart lock. Extra cards for family members and staff.",
...
if(form){
  form.addEventListener("submit",e=>{
    ...
    const text=buildMessage({
      ...
      address:fd.get("address"),install:fd.get("install")!=null,note:fd.get("note")});
